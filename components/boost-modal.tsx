      ...
      <div className="bg-gray-900 rounded-2xl p-6 w-full max-w-md border border-gray-700">
          ...
          <div className="mb-4">
            <button
              ...
              className={`w-full p-3 rounded-lg border-2 transition-all ${
                isCustom ? "border-red-400 bg-red-400/10" : "border-gray-600 hover:border-gray-500"
              }`}
            >
          ...
          {isCustom && (
            <div className="mb-4">
              <input
                ...
                className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-red-400 focus:outline-none"
                min="0.01"
                step="0.01"
              />
            </div>
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="flex-1 py-3 px-4 bg-red-400 hover:bg-red-500 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors flex items-center justify-center space-x-2"
          >
