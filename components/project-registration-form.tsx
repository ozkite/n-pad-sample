        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-800 border border-gray-600 rounded-lg py-2 px-3">
              <a
                ...
                className="text-[#E53E3E] hover:text-[#C53030] flex items-center"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-800 border border-gray-600 rounded-lg py-2 px-3 text-white focus:border-[#E53E3E] focus:outline-none mt-2"
